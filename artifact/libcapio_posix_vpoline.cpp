...
static int hook(long syscall_number, long arg0, long arg1, long arg2, long arg3, long arg4, long arg5, long *result) {
    static constexpr std::array<CPHandler_t, CAPIO_NR_SYSCALLS> syscallTable = build_syscall_table();
    ...
    START_LOG(capio_gettid(), "call(syscall_number=%ld)", syscall_number);
    ...
    try {
        ...
        std::cout << std::endl
                << "~~~~~~~~~~~~~~[\033[31mlibcapio_posix.so: FATAL EXCEPTION\033[0m]~~~~~~~~~~~~~~" << std::endl
                << "|  Exception thrown while handling:" << std::endl
                << "|  syscall(" << syscall_number << ", arg0:" << arg0 << ", arg1:" << arg1 << ", arg2:" << arg2
                << ", arg3:" << arg3 << ", arg4:" << arg4 << ", arg5: " << arg5 << ")" << std::endl
                << "|  TID of offending thread: " << capio_gettid() << std::endl
                << "|  PID of offending thread: " << capio_getpid() << std::endl
                << "|  PPID of offending thread: " << capio_getppid() << std::endl
                << "|  " << std::endl
...
extern "C" {
int __hook_init(long placeholder __attribute__((unused)), void *no_intercept_ptr, void **out_hook_ptr) {
    syscall_no_intercept = (syscall_fn_t) no_intercept_ptr;
    *out_hook_ptr = (void *) hook;
    const long tid = capio_gettid();
